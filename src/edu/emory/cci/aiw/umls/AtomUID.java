...
public final class AtomUID extends AbstractUMLSSearchUID 
							implements CUIQuerySearchUID {
	private static Pattern auidPattern;
	
	static {
		auidPattern = Pattern.compile("C\\d{7}");
	}
	...
	public static AtomUID fromString(String auid) 
		...
		if (m.matches()) {
			...
			throw new MalformedUMLSUniqueIdentifierException(
					"Concept Unique Identifiers must consist of the letter " +
