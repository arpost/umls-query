...
public class UMLSDatabaseConnectionTest {
	...
	public void testGetAvailableSAB() throws Exception {
		...
		Set<SABValue> expected = new HashSet<SABValue>();
		expected.add(SABValue.withNameAndDescription("SNMI", "SNOMED Clinical Terms, 2009_07_31"));
		expected.add(SABValue.withNameAndDescription("SCTSPA", "SNOMED Terminos Clinicos (SNOMED CT), Edicion en Espanol, Distribucion Internacional, Octubre de 2009, 2009_10_31"));
		expected.add(SABValue.withNameAndDescription("SNM", "SNOMED-2, 2"));
		expected.add(SABValue.withNameAndDescription("SNOMEDCT", "SNOMED International, 1998"));
		assertEquals(expected, actual);
	}
